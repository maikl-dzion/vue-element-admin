  ...
  <div class="mixin-components-container">
    ...
    <el-row style="margin-top:0px;">
      <el-col><el-card class="box-card">
        <div class="clearfix" style="text-align: left; margin-bottom: 10px; font-style: italic">Выбрать тип виджета</div>
    ...
    <el-row style="margin-top:0px;">
      ...
      <el-col :span="5">
        <el-card class="box-card">
          ...
          <div class="clearfix" style="text-align: center; margin-bottom: 10px">Список рабочих столов</div><hr>
